        ...
        >
          <div class="right">
            <el-form-item label="案例名称" label-width="150px" prop="casename">
              <el-input v-model="form.casename" class="workwidth" placeholder="请输入案例名称"></el-input>
            </el-form-item>
          </div>
          <div class="right">
            <el-form-item
              ...
              prop="username"
            >
              <el-input v-model="form.username" class="workwidth" placeholder="请输入负责人姓名"></el-input>
            </el-form-item>
          </div>
        </el-form>
        <!---第二排-->
        ...
        >
          <div class="right">
            <el-form-item
              ...
              prop="subadress"
            >
              <el-input v-model="form.subadress" class="workwidth" placeholder="请输入报送单位" ></el-input>
            </el-form-item>
          </div>
          <div class="right">
            <el-form-item
        ...
        >
          <div class="right">
            <el-form-item
              ...
              prop="prinduty"
            >
              <el-input v-model="form.prinduty" class="workwidth" placeholder="请输入负责人职务"></el-input>
            </el-form-item>
          </div>
          <div class="right">
            <el-form-item
              ...
              prop="userunit"
            >
              <el-input v-model="form.userunit" class="workwidth"  placeholder="请输入负责人单位"></el-input>
            </el-form-item>
          </div>
        </el-form>
        <!---第四排-->
        ...
        >
          <div class="right">
            <el-form-item label="案例代码" label-width="150px" prop="casecode">
              <el-input v-model="form.casecode" class="workwidth"  placeholder="请输入案例代码"></el-input>
            </el-form-item>
          </div>
        </el-form>
        <!--第六排作者-->
